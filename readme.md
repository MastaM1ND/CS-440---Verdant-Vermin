While table-setup shows the sql queries to replicate the backend, the application will run via a cloud hosted backend so long as you are using an IPv6 Wifi/internet connection
